...
from seq_vae_2.generator import Generator
from seq_vae_2.rollout import ROLLOUT
...
def main():
    ...
    # configuration
    config = configs.CONFIG_MAP['t_8'] # t_8 t_20 t_64
    ...
    negative_file = '../save/seq_vae_2_' + time_str + '_' + config.negative_file_txt
    ...
    log_fn = '../save/seq_vae_2_' + time_str + '.log'
    ...
    with graph.as_default():
        ...
        for total_batch in range(TOTAL_BATCH):
            ...
            for it in range(1):
                ...
                rewards = rollout.get_reward(sess, samples, z, rollout_num, hparams.compute_rewards_step, discriminator)
